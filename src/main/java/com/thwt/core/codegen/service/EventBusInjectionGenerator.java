 ...
 *
 */
public class EventBusInjectionGenerator implements InjectionFieldInitializerGenerator {
  ...
  public void generateInjectionFieldInitializer(ICodeGenerationContext context,
    ...
    String text = context.getTemplateRenderer().renderFromFile("/META-INF/templates/eventBusInjectionInitializer.vm", attributes);
  ...
  public boolean applyableOnType(String valueType, Element elem) {
    return EventBus.class.getCanonicalName().equals(valueType);
  }
