/*
 * @(#)VertxContextInjectionGenerator.java	 2017-02-17
 *
 ...
 *
 */
public class VertxContextInjectionGenerator implements InjectionFieldInitializerGenerator {
  ...
  public void generateInjectionFieldInitializer(ICodeGenerationContext context,
    ...
    String text = context.getTemplateRenderer().renderFromFile("/META-INF/templates/vertxContextInjectionInitializer.vm", attributes);
  ...
  public boolean applyableOnType(String valueType, Element elem) {
    return Context.class.getCanonicalName().equals(valueType);
  }
