...
public enum ClassKind {
  ...
  public static ClassKind getKind(
    ...
    if (isDataObjectAnnotated) {
      ...
      return CLASS_TYPE;
    } else if (fqcn.equals(TypeInfo.VERTX_HANDLER)) {
      return HANDLER;
    } else if (fqcn.equals(TypeInfo.VERTX_ASYNC_RESULT)) {
      return ASYNC_RESULT;
    } else if (fqcn.equals(TypeInfo.JSON_ARRAY) || fqcn.equals(TypeInfo.IJSON_ARRAY)) {
      return JSON_ARRAY;
    } else if (fqcn.equals(TypeInfo.JSON_OBJECT) || fqcn.equals(TypeInfo.IJSON_OBJECT)) {
      return JSON_OBJECT;
      ...
      return FUNCTION;
    } else if (fqcn.equals(Date.class.getName())) {
        return DATE_TYPE;
    } else if (fqcn.equals(Timestamp.class.getName())) {
        return DATE_TYPE;
    } else if (fqcn.equals(java.sql.Date.class.getName())) {
        return DATE_TYPE;
