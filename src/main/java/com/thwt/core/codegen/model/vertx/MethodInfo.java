...
import com.thwt.core.codegen.model.type.Text;
...
//  }
  ...
  public void collectImports(ImportManager mgr) {
    for(TypeInfo a : FluentIterable.from(params).transform(new Function<ParamInfo, TypeInfo>() {

      @Override
      public TypeInfo apply(ParamInfo p) {
        return p.getType();
      }
    }).toList()) {
